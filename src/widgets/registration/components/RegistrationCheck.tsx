    ...
    return (
        <>
            <article className="pt-14 ">
                <div className="bg-[#ECF5F8]  h-[750px] w-[400px]">
                    <div className=" flex flex-col justify-center items-center">
                        ...
                        <div className="flex flex-col justify-center items-center text-[18px] font-semibold pt-48">
                            <p>요고 요금제를</p>
                            <p>변경하기 전 확인해 주세요.</p>
                        </div>
